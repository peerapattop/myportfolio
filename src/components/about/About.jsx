      ...
      <div className="about__container grid">
        ...
        <div className='about__data grid'>
          <div className="about__info">
            <p className="about__description">My name is Pirapat Tangpanyawai. My nickname is Top. I am 22 years old. I live in Bangkok. Now I'm a student at King Mongkut's University of Technology North Bangkok. In the
              future, I hope I will be a good programmer. After graduating bachelor's degree, I plan to be a
